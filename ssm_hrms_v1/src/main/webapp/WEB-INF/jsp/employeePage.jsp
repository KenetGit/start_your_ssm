            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination">
                            <li><a href="/hrms/emp/getEmpInfoList?pageNo=1">首页</a></li>
                            <c:if test="${curPage==1}">
                                <li class="disabled">
                            ...
                            <c:forEach begin="1" end="${totalPages<5?totalPages:5}" step="1" var="itemPage">
                                <c:if test="${curPage == itemPage}">
                                    <li class="active"><a href="/hrms/emp/getEmpInfoList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                                <c:if test="${curPage != itemPage}">
                                    <li><a href="/hrms/emp/getEmpInfoList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <li><a href="/hrms/emp/getEmpInfoList?pageNo=${totalPages}">尾页</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    $(function () {
        ...
        $(".prePage").click(function () {
            if (curPage > 1){
                ...
                $(this).attr("href", "/hrms/emp/getEmpInfoList?pageNo="+pageNo);
            }
        });
        //下一页
        $(".nextPage").click(function (result) {
        ...
        if (confirm("确认删除【" + delEmpName+ "】的信息吗？")){
            $.ajax({
                ...
                success:function (result) {
                    if (result.code == 100){
                        alert("删除成功！");
                        window.location.href="/hrms/emp/getEmpInfoList?pageNo="+curPage;
                    }else {
